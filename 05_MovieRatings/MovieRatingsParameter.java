...
public class MovieRatingsParameter {
    ...
    public String toString() {
        ...
        stringBuilder.append(this.movietitle).append(t).append(this.releaseYear).append(t)
               .append(this.imdb_web_url).append(t).append(this.movie_ratings_Average.toString()).append(t)
               .append(this.unique_users.toString()).append(t).append(this.movie_ratings.toString());
